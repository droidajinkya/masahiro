...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    widget.controller.startBackgroundListeners((enabled) async {
      await _syncTorchState(enabled);
    });
  ...
  Future<void> _syncTorchState(bool targetOn) async {
    final currentOn = _scannerController.torchState.value == TorchState.on;
  ...
  Future<void> _toggleFlash() async {
    final nextValue = !widget.controller.flashOn;
    await _syncTorchState(nextValue);
    widget.controller.setManualFlashState(nextValue);
  }
